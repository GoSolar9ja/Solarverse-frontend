...
import { IBaseSelectInputProps } from "./base-select-input";
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={selectInputTheme({
        className: cn(
          " data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground   dark:hover:bg-input/50 flex w-fit items-center justify-between gap-2 px-5 py-2  whitespace-nowrap   disabled:cursor-not-allowed disabled:opacity-50  *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 outline-primary outline",
          className
        ),
        variant,
        fieldError,
