...
const reviews = [
  {
    name: "Emmanuel O., Lead Technician, Enugu",
    description:
      "This platform changed my business. I now get steady clients every month.",
    rating: 5,
  },
  {
    name: "Blessing A., Certified Installer, Abuja",
    description:
      "I love that I can pick my projects, set my price, and work on my terms.",
    rating: 5,
  },
  {
    name: "Tunde A., Solar Pro, Lagos",
    description:
      "Finally, a platform that respects installers and helps us grow.",
    rating: 5,
  },
];

export default function InstallerStoriesSection() {
  return (
    <SectionLayout
      ...
      header={
        <div>
          ...
          <Typography.h6 className="text-[#11121499] mt-2">
            Reviews from Installers who used our service{" "}
          </Typography.h6>
        </div>
      }
    >
      <div className="flex flex-col xl:!flex-row justify-between items-center xl:!items-start mt-20 xl:!pl-20 gap-20 xl:!gap-0">
        <div className="relative max-w-[445px] w-full xl:!flex-1 h-[402px] order-2 xl:!order-1">
          <div className=" relative  rounded-[30px] h-full overflow-hidden">
            ...
            <Image src={IMAGE_URLS.installerStoryImg} alt="home and business" />
          </div>
