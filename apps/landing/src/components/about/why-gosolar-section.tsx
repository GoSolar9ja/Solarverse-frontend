...
const list = [
  "Multiple quotes from vetted installers",
  "Easy scheduling and project tracking",
  "Secure payments and flexible financing",
  "Reviews and ratings for informed decisions",
];

export default function WhyGoSolarSection() {
  return (
    <section className="md:!py-38 py-10">
      <DefaultLayout>
        <div className=" max-w-[467.3px]">
          <Typography.h3 weight={"medium"}>Why GoSolar9ja?</Typography.h3>
        ...
        <div className="relative">
          <div className="bg-[#2495D1] py-16 sm:!px-28 px-10 rounded-4xl relative overflow-hidden mt-8">
          ...
          <div className="absolute -top-18 right-18 bg-black h-[483px] w-[456px] xl:!flex rounded-[20px] hidden">
            <Image
