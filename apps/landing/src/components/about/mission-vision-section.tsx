    ...
    <section className="md:!pt-[300px] pt-26">
      <DefaultLayout>
        <div className="flex md:!flex-row flex-col items-center gap-10 mt-20">
          ...
          <Card
            title="Our Vision"
            content="To accelerate Nigeria's energy transformation by becoming the most trusted solar installation marketplace in West Africa."
          />
        </div>
      </DefaultLayout>
    </section>
...
const Card = ({ title, content }: { title: string; content: string }) => {
  return (
    <div className="flex flex-col gap-[20px] bg-[#F3910D0D] max-w-[603px]  h-[298px] flex-1">
